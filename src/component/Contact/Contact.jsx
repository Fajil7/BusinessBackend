            ...
            <div>
                ...
                <div className="img-and-form-container">
                    ...
                    <form className="form-container">
                        <p className="contact-text">Fill out the form with your details and message, and one of our representatives will reach out to you shortly. We look forward to connecting with you!</p>



                        <div className='two-input-contianer flex items-center gap-8'>
                        ...
                        <div className="textarea-container-mine relative w-10/12 min-w-[200px]">
                            <textarea
                                class="peer h-full min-h-[100px] w-full resize-none rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-1 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:resize-none disabled:border-0 disabled:bg-blue-gray-50"
                                placeholder=" ">
                            </textarea>
                            <label
